...
class Client:
    ...
    __waitingTime: float
    __serviceTime: float
    stationArrivalTime = cython.declare(cython.float, visibility='public')
    removeEvent: Optional[Event]
    ...
    @cython.ccall
    def add_waiting(self, time: float):
    ...
    @cython.ccall
    def add_service(self, time: float):
...
class Station:
    ...
    __simulator: Simulator
    __lastArrivalTime: float
    __statistic: RecordDiscrete
    ...
    @cython.ccall
    def arrival(self, client: Client):
...
class Source(Station):
    ...
    __getB: Any
    __type_name: str
    __nextStation: Optional[Station]
    ...
    @cython.ccall
    def arrival(self, client: Client):
        super(Source, self).arrival(client)
        client.send_to(self.__nextStation)

    @cython.ccall
    def event(self, client: Optional[Client]):
...
class Dispose(Station):
    ...
    __statisticClientWaiting: RecordDiscrete
    __statisticClientService: RecordDiscrete
    __statisticClientResidence: RecordDiscrete
    ...
    @cython.ccall
    def arrival(self, client: Client):
        super(Dispose, self).arrival(client)
...
class Process(Station):
    ...
    __getS: Any
    __getS_client_type: Any
    __getS2: Any
    __getNu: Any
    __getNu_client_type: Any
    __c: int
    __cBusy: int
    __K: int
    __b: int
    ...
    __wip: int
    __queue: list[Client]
    __nextStationCancel: Optional[Station]
    __statisticStationWaiting: RecordDiscrete
    __statisticStationService: RecordDiscrete
    __statisticStationPostProcessing: RecordDiscrete
    __statisticStationResidence: RecordDiscrete
    __statisticSuccess: RecordOptions
    __statisticQueueLength: RecordContinuous
    __statisticWIP: RecordContinuous
    __statisticWorkload: RecordContinuous
    __nextStation: Optional[Station]
    ...
    @cython.ccall
    def _send_client_to_next(self, client: Client, success: bool):
        if success:
    ...
    @cython.ccall
    def arrival(self, client: Client):
        super(Process, self).arrival(client)
    ...
    @cython.ccall
    def waiting_cancelation_event(self, client: Client):
    ...
    @cython.ccall
    def _get_next_client_from_queue(self):
    ...
    @cython.ccall
    def _get_service_time(self, clients: list):
...
class Decide(Station):
    ...
    __rate: list[float]
    __rateSum: float
    __station: list[Station]
    __statisticOptions: RecordOptions
    ...
    @cython.ccall
    def arrival(self, client: Client):
        super(Decide, self).arrival(client)
...
class DecideCondition(Station):
    ...
    def arrival(self, client: Client) -> None:
        super(DecideCondition, self).arrival(client)
...
class DecideClientType(Station):
    ...
    def arrival(self, client: Client) -> None:
        super(DecideClientType, self).arrival(client)
        client_type: str = client.type_name
...
class Delay(Station):
    ...
    @cython.ccall
    def arrival(self, client: Client):
        super(Delay, self).arrival(client)
        self.__wip += 1
